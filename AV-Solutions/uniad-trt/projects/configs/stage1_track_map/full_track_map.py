...
# Based on https://github.com/OpenDriveLab/UniAD/blob/main/projects/configs/stage1_track_map/base_track_map.py
# Full-size UniAD-base config for stage1 training (track + map)
# Changes from tiny: ResNet-101, 200x200 BEV, 6 encoder layers, full image resolution, multi-scale FPN
...
evaluation_ranges = {'30x30': (70, 130), '50x50': (0, 200)}
bevslicer=True
...
# NOTE: You need a BEVFormer-base pretrained checkpoint here.
# Download from https://github.com/fundamentalvision/BEVFormer or train your own.
