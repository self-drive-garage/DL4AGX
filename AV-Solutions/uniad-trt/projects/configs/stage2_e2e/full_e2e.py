...
# Based on https://github.com/OpenDriveLab/UniAD/blob/main/projects/configs/stage2_e2e/base_e2e.py
# Full-size UniAD-base config for stage2 end-to-end training
...
# Load the stage1 full-size checkpoint
load_from = "ckpts/full_track_map.pth"
